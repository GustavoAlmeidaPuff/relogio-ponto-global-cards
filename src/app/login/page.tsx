    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-100">
      <div className="w-full max-w-sm bg-white rounded-xl shadow-lg p-6">
        ...
        <button
          ...
          className="w-full py-2.5 border border-slate-300 rounded-lg font-medium text-slate-700 bg-white hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          className="w-full mt-4 text-sm text-slate-600 hover:text-slate-800"
        >
